...
const statusColors: Record<string, string> = {
  payment_confirmed: "text-primary bg-[#DBEAFE]",
  documents_received: "text-[#4C1D95] bg-[#EDE9FE]",
                      ...
                      >
                        ...
                        <div className="mt-6 pt-5 border-t border-border flex flex-col sm:flex-row gap-3 sm:items-center justify-between">
                          ...
                          <div className="flex gap-2">
                            <a href="https://wa.me/917387731313" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-success/10 text-success text-xs font-semibold hover:bg-success/20 transition-colors">
                ...
                <motion.div variants={fadeInUp} initial="hidden" animate="visible" className="space-y-4">
                  ...
                  <div className="premium-card p-6 md:p-8 border-l-4 border-l-success">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <a href="https://wa.me/917387731313" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-success text-white text-sm font-semibold hover:opacity-90 transition-opacity">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="premium-card p-6">
                      ...
                      <a href="tel:+917387731313" className="text-sm font-semibold text-primary hover:underline flex items-center gap-1">
                    ...
                    <div className="premium-card p-6">
                      ...
                      <a href="mailto:info@klawtax.online" className="text-sm font-semibold text-primary hover:underline flex items-center gap-1">
                        info@klawtax.online <ArrowRight className="w-3 h-3" />
                      </a>
                    </div>
                  </div>
