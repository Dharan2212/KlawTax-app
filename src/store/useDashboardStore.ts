...
export const useDashboardStore = create<DashboardState>((set) => ({
  orders: [
    { id: "KT-ABC123", service: "Section 8 Company Registration", status: "processing", date: "2026-04-28", amount: 14999, paidAmount: 7500, pendingAmount: 7499 },
    { id: "KT-DEF456", service: "12A & 80G Registration", status: "documents_received", date: "2026-05-01", amount: 7999, paidAmount: 7999, pendingAmount: 0 },
  ],
  updates: [
