...
const WA_LINK = "https://wa.me/917387731313?text=" + encodeURIComponent("Hi KlawTax! I'm interested in the Complete NGO Package.");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <Star size={11} strokeWidth={2} style={{ fill: "#FCD34D", color: "#FCD34D" }} />
            ...
            <motion.div variants={staggerItem} className="flex flex-wrap gap-3">
              {[
                ...
                >
                  <Icon size={11} strokeWidth={2} style={{ color: "#F59E0B" }} />
                  {text}
                </div>
              ))}
            </motion.div>
              ...
              <div className="p-7">
                ...
                >
                  <p className="text-xs" style={{ color: "rgba(255,255,255,0.55)", fontFamily: "'DM Sans', sans-serif" }}>
                    Start for just{" "}
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 600, color: "#FCD34D" }}>
