      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main role="main" className="pt-28 pb-16 flex-1 flex items-center justify-center px-4">
          <motion.div variants={scaleIn} initial="hidden" animate="visible" className="max-w-lg w-full text-center premium-card p-10">
            ...
            <a
              href={`https://wa.me/917387731313?text=Documents%20submitted%20for%20order%20${orderId || "my order"}`}
            ...
            <div className="flex items-center gap-4 p-4 rounded-xl bg-success/8 border border-success/25">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Order: <span className="font-mono font-semibold">{orderId || "Pending Assignment"}</span>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-5 mb-6">
              ...
              <div className="premium-card p-6 border-l-4 border-l-success">
                ...
                <a
                  href={`https://wa.me/917387731313?text=Submitting%20docs%20for%20${orderId || "my order"}%20-%20${encodeURIComponent(serviceName || "service")}`}
                  target="_blank" rel="noopener noreferrer"
              ...
              <div className="premium-card p-6">
                ...
                <div
                  className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${isDragging ? "border-primary bg-[#EFF6FF] scale-[1.01]" : "border-border hover:border-primary/40 hover:bg-muted/40"}`}
            ...
            <div className="rounded-xl bg-muted/60 border border-border p-5">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="tel:+917387731313" className="flex items-center gap-2 px-4 py-2.5 rounded-lg border border-border bg-white text-sm font-medium text-foreground hover:bg-muted transition-colors">
                  <Phone className="w-4 h-4 text-primary" />Call Support
                </a>
                <a href="https://wa.me/917387731313" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-success/10 text-success text-sm font-semibold hover:bg-success/20 transition-colors">
