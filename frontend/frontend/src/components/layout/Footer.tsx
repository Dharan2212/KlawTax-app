...
const footerLinks = {
  ngo: [
    ...
    { label: "CSR-1 Registration",   href: "/services/csr-registration"         },
    { label: "Udyam Registration",   href: "/services/udyam-registration"       },
  ],
  business: [
    { label: "Private Limited Co.",  href: "/services/private-limited-company"  },
    { label: "LLP Registration",     href: "/services/llp-registration"         },
    { label: "GST Registration",     href: "/services/gst-registration"         },
    { label: "FSSAI Registration",   href: "/services/fssai-registration"       },
    { label: "ITR Filing (NGO)",     href: "/services/ngo-itr-filing"           },
    { label: "Audit + UDIN",         href: "/services/ngo-audit-udin"           },
    { label: "NGO Website",          href: "/services/ngo-website-development"  },
  ],
  company: [
...
const contactItems: { icon: typeof Phone; text: string; href: string | null; external?: boolean }[] = [
  { icon: Phone,  text: "+91 73877 31313",           href: "tel:+917387731313"             },
  { icon: Mail,   text: "info@klawtax.online",    href: "mailto:info@klawtax.online" },
